      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-notable-50 text-notable-700 rounded-full text-sm font-medium mb-6">
            ...
            AI is changing how buyers find realtors
          </div>
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Your Competitors Are Showing Up in AI Search.  <span className="text-notable-600">Are You?</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Buyers are asking ChatGPT or Perplexity "Who's the best agent in [neighborhood]?" 
            If you're not being mentioned, you're losing opportunities. 
            Notable shows you how you rank and gives you the exact playbook to improve.
          </p>
