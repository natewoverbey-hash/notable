...
function extractCompetitors(response: string, excludeAgent: string): Array<{ name: string; rank: number }> {
  ...
  const falsePositives = [
    ...
    // Advice section headers (Gemini loves these)
    'technology proficiency', 'rental potential', 'property management', 
    'referral networks', 'check references', 'read reviews', 'interview agents',
    'consider your needs', 'check credentials', 'your specific needs',
    'local expertise', 'define your needs', 'trust your gut', 'please note',
    'high volume', 'marketing expertise', 'interview several agents',
    'why these agents', 'why these agents are', 'negotiation skills',
    'communication skills', 'ask for referrals', 'focus on', 'look for',
    'how to find', 'key notes', 'important notes', 'additional tips',
    'next steps', 'final thoughts', 'bottom line', 'in summary',
    'pro tip', 'quick tip', 'keep in mind', 'remember that',
    // Websites/platforms
